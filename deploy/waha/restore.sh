...
echo "stopping waha and bridge"
docker compose -f /opt/waha/docker-compose.yml stop waha bridge
...
echo "starting waha and bridge"
docker compose -f /opt/waha/docker-compose.yml up -d waha bridge
