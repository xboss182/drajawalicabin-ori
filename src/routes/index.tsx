  ...
  head: () => ({
    meta: [
      { title: "Rajawali D'Cabin Chalet | Roomstay & Chalet Chendering, KT" },
      {
        name: "description",
        content:
          "Rajawali D'Cabin Chalet — Muslim-friendly riverside chalet & roomstay in Chendering, Kuala Terengganu. 8 private cabins for family staycations near the city.",
      },
      {
        name: "keywords",
        content:
          "Rajawali D'Cabin Chalet, Chalet Chendering, Roomstay Chendering, Chalet Kuala Terengganu, Roomstay Kuala Terengganu, Accommodation Kuala Terengganu, Staycation Kuala Terengganu, Family Chalet Terengganu, Muslim-friendly Chalet Kuala Terengganu",
      },
      { name: "robots", content: "index, follow" },
      {
        property: "og:title",
        content: "Rajawali D'Cabin Chalet — Chalet & Roomstay in Chendering, KT",
      },
      {
        property: "og:description",
        content:
          "Muslim-friendly riverside chalet in Chendering, Kuala Terengganu. 8 private family-friendly cabins for a peaceful Terengganu staycation.",
      },
      ...
      { property: "og:image", content: heroRiverside },
      {
        ...
        content: "Riverside cabins at Rajawali D'Cabin Chalet, Chendering",
      },
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "twitter:title",
        content: "Rajawali D'Cabin Chalet — Chalet Chendering, Kuala Terengganu",
      },
      {
        name: "twitter:description",
        content:
          "Muslim-friendly riverside chalet & roomstay in Chendering, KT. 8 private cabins for a quiet family staycation.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Muslim-friendly riverside chalet and roomstay in Chendering, Kuala Terengganu, Terengganu, Malaysia. 8 private cabins for family staycations.",
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Rajawali D'Cabin Chalet is a riverside chalet in Chendering, Kuala Terengganu, Terengganu — a short drive from the Kuala Terengganu city centre.",
              },
            },
            {
              "@type": "Question",
            ...
            },
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes. Up to 2 children under 12 years old stay free per room, sharing the existing bedding.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes. The chalet is family-friendly and Muslim-friendly, with private cabins suitable for families and groups visiting Kuala Terengganu.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Check-in is from 3:00 PM and check-out is by 12:00 PM.",
              },
            },
          ],
        }),
    ...
    <header className="absolute left-0 right-0 top-0 z-30">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 text-sm text-coconut/90 md:flex">
          <a href="#stay" className="hover:text-coconut">
            {t.nav.cabins}
          </a>
          <a href="#about" className="hover:text-coconut">
            {t.nav.about}
          </a>
          <a href="#nearby" className="hover:text-coconut">
            {t.nav.nearby}
          </a>
          <Link to="/gallery" className="hover:text-coconut">
            Gallery
          </Link>
          <Link to="/booking-guide" className="hover:text-coconut">
            Guide
          </Link>
          <a href="#book" className="hover:text-coconut">
            {t.nav.book}
          </a>
          <Link
            to="/manage-booking"
        ...
        <div className="flex items-center gap-3">
          ...
          <BookInWhatsAppLink className="hidden sm:inline-flex rounded-full border border-coconut/40 bg-coconut/10 px-4 py-2 text-xs uppercase tracking-widest text-coconut backdrop-blur transition hover:bg-coconut hover:text-forest">
            {t.nav.whatsapp}
          </BookInWhatsAppLink>
        </div>
      </div>
...
function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[62svh] w-full overflow-hidden sm:min-h-[78svh] lg:min-h-[82svh]"
    >
      <img
        src={heroRiverside}
      ...
      <div className="relative mx-auto flex min-h-[62svh] max-w-7xl flex-col justify-end px-6 pb-14 pt-20 text-coconut sm:min-h-[78svh] sm:pb-28 sm:pt-32 lg:min-h-[82svh] lg:px-10 lg:pb-32 lg:pt-36">
        ...
        <p className="mt-5 max-w-xl text-base text-coconut/85 sm:text-lg">{t.hero.body}</p>
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          {promoEnabled && (
            <div className="sm:ml-auto inline-flex items-center gap-2 rounded-full border border-sand/50 bg-forest/40 px-3.5 py-2 text-xs font-medium leading-snug text-coconut shadow-md backdrop-blur-md sm:text-sm sm:leading-relaxed">
              ...
              <span className="leading-snug text-sand sm:leading-relaxed">{promoText}</span>
            </div>
          )}
        </div>
        <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-[11px] uppercase tracking-[0.25em] text-coconut/70">
          ...
          <span className="hidden sm:inline opacity-50">·</span>
          <BookInWhatsAppLink className="hover:text-coconut">WhatsApp booking</BookInWhatsAppLink>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section id="about" className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-24">
      <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        <div>
          <p className="mb-3 text-[11px] uppercase tracking-[0.3em] text-stone">
            {t.about.eyebrow}
          </p>
          ...
          <div className="mt-8 flex items-center gap-5 border-t border-border pt-6">
            ...
            <a
              href="#stay"
              className="ml-auto inline-flex items-center gap-2 text-sm text-forest hover:gap-3 transition-all"
            >
              Explore the cabins →
            </a>
          </div>
    ...
    <section id="stay" className="bg-secondary/40 py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
          ...
          <p className="max-w-sm text-sm text-foreground/70">{t.stay.intro}</p>
        </div>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {t.stay.cabins.map((c, idx) => (
            <article
              key={c.name}
              className="group flex flex-col overflow-hidden rounded-lg bg-card shadow-sm"
            >
              <div className="relative">
                <CabinCarousel
                  images={[cabinImages[idx], cabinToilets[idx]]}
                  alt={`${c.name} interior`}
                />
    ...
    <section id="nearby" className="bg-forest text-coconut py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mb-10 max-w-2xl">
          <p className="mb-3 text-[11px] uppercase tracking-[0.3em] text-coconut/60">
            {t.nearby.eyebrow}
          </p>
          <h2 className="font-display text-4xl leading-tight sm:text-5xl">{t.nearby.title}</h2>
          <p className="mt-4 text-coconut/75">{t.nearby.body}</p>
        ...
        <div className="-mx-6 flex snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-2 md:mx-0 md:grid md:grid-cols-3 md:gap-5 md:overflow-visible md:px-0 md:pb-0">
          {t.nearby.items.map((n, idx) => (
            <figure
              key={n.name}
              className="group w-[78%] shrink-0 snap-start overflow-hidden rounded-lg md:w-auto md:shrink"
            >
    ...
    <footer className="bg-coconut text-foreground">
      <div className="mx-auto grid max-w-7xl gap-8 px-6 py-10 sm:gap-12 sm:py-20 lg:grid-cols-[1.4fr_1fr_1fr] lg:px-10">
        ...
        <div className="text-sm">
          <p className="mb-3 text-[11px] uppercase tracking-[0.25em] text-stone">
            {t.footer.visit}
          </p>
        ...
        <div className="text-sm">
          ...
          <ul className="space-y-2 text-foreground/80">
            <li>
              <BookInWhatsAppLink className="hover:text-forest">
                {t.footer.whatsapp}
              </BookInWhatsAppLink>
            </li>
            <li>
              <a
                href="https://www.facebook.com/p/Rajawali-DCabin-Chalet-100068093830245/"
                target="_blank"
                rel="noreferrer"
...
function MobileCtaBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 px-4 py-2 backdrop-blur md:hidden">
      <BookInWhatsAppLink className="flex w-full items-center justify-center gap-2 rounded-full bg-forest px-4 py-2.5 text-center text-sm font-semibold uppercase tracking-wider text-coconut">
