...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A boutique chalet retreat of 8 private cabins in Kuala Ibai, Kuala Terengganu. Wake to birdsong, coastal air, and a slower pace of life." },
      { name: "author", content: "Rajawali D'Cabin Chalet" },
      { property: "og:title", content: "Rajawali D'Cabin Chalet — Hidden Riverside Cabins" },
      { property: "og:description", content: "Only 8 private cabins in Kuala Ibai, Terengganu. A peaceful retreat for families, couples, and weekend escapes." },
