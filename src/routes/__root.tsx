    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: ["Rajawali DCabin Chalet", "D'Cabin Chalet", "Rajawali Chalet Chendering"],
          url: "https://drajawalicabin.com/",
          inLanguage: ["en-MY", "ms-MY"],
          potentialAction: {
            "@type": "SearchAction",
            target: "https://drajawalicabin.com/book?checkIn={search_term_string}",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Rajawali D'Cabin Chalet",
          alternateName: ["Rajawali DCabin Chalet", "D'Cabin Chalet"],
          url: "https://drajawalicabin.com/",
          logo: "https://drajawalicabin.com/favicon.ico",
        }),
      },
    ],
  }),
