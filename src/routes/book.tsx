...
function StaySummaryCard(props: StaySummaryCardProps) {
  ...
  const bt = t.book;
  const {
    previewCabin, cart, groupByType, totalRooms,
    checkin, checkout, guests, kids, price, discounts,
    couponInput, setCouponInput, couponRow, couponError, couponApplying,
    applyCoupon, clearCoupon, couponAmount,
  } = props;
