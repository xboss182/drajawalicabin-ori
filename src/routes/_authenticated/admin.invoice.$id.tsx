                  ...
                  <Fragment key={r.id}>
                    ...
                    {r.comforterTotal > 0 && (
                      <tr className="border-b border-border/40">
                        ...
                        <td className="pb-2" />
                        <td className="pb-2 text-right text-xs text-stone">{money(r.comforterTotal)}</td>
                        <td className="pb-2" />
                        <td className="pb-2" />
                      </tr>
                    )}
            ...
            <table className="mt-2 w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-border/40">
                  ...
                  <td className="py-2 text-right">{money(isFullPayment ? inv.total + inv.securityDeposit : inv.securityDeposit)}</td>
                  <td className="py-2">
                    {inv.depositProofUrl ? (
                      <a
