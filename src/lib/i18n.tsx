...
export const translations = {
  en: {
    ...
    about: {
      ...
      p1: "Tucked into the greenery of Chendering, Rajawali D'Cabin Chalet is a small collection of private cabins — close enough to the city for an easy errand, far enough to forget your inbox.",
    ...
    book: {
      ...
      g: {
        ...
        phonePh: "",
        icNumber: "Identification card number",
        icNumberPh: "",
      ...
      errors: {
        ...
        icNumber: "IC number must be 12 digits (e.g. 900101-11-5566)",
        vehicleType: "Vehicle type should only contain letters",
        vehicleNumber: "Vehicle number should only contain letters and digits (e.g. WXY 1234)",
  ...
  bm: {
    ...
    about: {
      ...
      title2: "Kuala Terengganu.",
      p1: "Tersembunyi di dalam kehijauan alam Chendering, Rajawali D'Cabin Chalet menawarkan pilihan kabin persendirian yang eksklusif — cukup dekat dengan bandar untuk urusan harian, cukup jauh untuk anda melupakan peti masuk e-mel anda.",
    ...
    book: {
      ...
      errors: {
        ...
        icNumber: "No KP mesti 12 digit (cth. 900101-11-5566)",
        vehicleType: "Jenis kenderaan hanya boleh mengandungi huruf",
        vehicleNumber: "No kenderaan hanya boleh mengandungi huruf dan nombor (cth. WXY 1234)",
